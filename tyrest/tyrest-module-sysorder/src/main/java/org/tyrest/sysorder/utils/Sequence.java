package org.tyrest.sysorder.utils;

import java.text.SimpleDateFormat;
import java.util.Date;

import org.tyrest.sysorder.constants.ParamsConstants;
...
public class Sequence {
	...
	public synchronized static  String generatorOrderSn() {
		return generatorSequence(3, ParamsConstants.DATAFORMAT_STR);
	}
	...
	public synchronized static String generatorSerialNo() {
		return generatorSequence(8, ParamsConstants.DATAFORMAT_STR);
	}
