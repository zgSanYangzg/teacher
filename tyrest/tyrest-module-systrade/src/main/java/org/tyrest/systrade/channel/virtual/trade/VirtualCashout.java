 ...
 * 
 *  Notes:
 *  $Id: VirtualPayment.java  Tyrest\magintrursh $ 
 * 
 *  Revision History
 *  &lt;Date&gt;,			&lt;Who&gt;,			&lt;What&gt;
 ...
 * </pre>
 */
@Component(value = "virtualCashout")
public class VirtualCashout implements Trade{
	...
	public TradeResultModel process(TransactionsSerialModel serialModel, Map<String, Object> extra) throws Exception
	{
		...
		boolean result 					= accountManager.executeTrade(DefaultAccountTradeType.CASHOUT, tradeParams);
