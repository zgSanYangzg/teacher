...
function program10(depth0,data) {
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  // modify by xiyt
  buffer += "<span style=\"font-size: 0.9em;float: right;\">Copyright (C) 2014 Tyrest.org All Rights Reserved.</span>\n    </h4>\n    </div>\n</div>\n";
  return buffer;
  });
})();
...
function program5(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</p>\n        ";
  //show funId of current tyrest operation
  buffer += "\n        <h4>FunId</h4>\n        <p>";
  buffer += depth0.funId;
  buffer += "</p>\n        ";
...
function program24(depth0,data) {
  ...
  return "\n          <div class='sandbox_header'>\n            <input class='submit' name='commit' type='button' value='"+ SwaggerUi.i18n[swaggerUi.language].tryItOut + "' />\n            <a href='#' class='response_hider' style='display:none'>Hide Response</a>\n            <span class='response_throbber' style='display:none'></span>\n          </div>\n          ";
  }
  ...
  buffer += escapeExpression(stack1)
    + "' class='toggleOperation " + (depth0.needAuth === 'true' ? "":" no_auth") +"'>";
  if (stack1 = helpers.method) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.method; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  
  buffer += escapeExpression(stack1)
    + (depth0.needAuth === 'true' ? "":" [no auth]") +"</a>\n          </span>\n          <span class='path'>\n          <a href='#!/";
  if (stack1 = helpers.parentId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.parentId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "/";
...
function program3(depth0,data) {
  ...
  buffer += depth0.url + escapeExpression(stack1)
    + "'>Raw</a>\n    </li>";
  return buffer;*/
  return "<li>\n      <a href='"+depth0+"'>"+ SwaggerUi.i18n[swaggerUi.language].raw +"</a>\n    </li>";
  }
  ...
  buffer += escapeExpression(stack1)
    + "\">"+ SwaggerUi.i18n[swaggerUi.language].show + "/" + SwaggerUi.i18n[swaggerUi.language].hide +"</a>\n    </li>\n    <li>\n      <a href='#' class=\"collapseResource\" data-id=\"";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.id; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n        "+ SwaggerUi.i18n[swaggerUi.language].listOperations + "\n      </a>\n    </li>\n    <li>\n      <a href='#' class=\"expandResource\" data-id=";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.id; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + ">\n        "+ SwaggerUi.i18n[swaggerUi.language].expandOperations + "\n      </a>\n    </li>\n    ";
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.addResource = function(resource, auths) {
      ...
      resourceView = new ResourceView({
        ...
        className: 'resource',
        auths: auths,
        attributes:{'summary':resource.id + resource.description},
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.addOperation = function(operation) {
      ...
      operationView = new OperationView({
        model: operation,
        tagName: 'li',
        className: 'endpoint ' + operation.apiLevel,
        attributes:{'summary':operation.summary + operation.nickname},
        swaggerOptions: this.options.swaggerOptions,
        auths: this.auths
      });
