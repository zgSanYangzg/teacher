...
(function () {
  ...
  SwaggerResource.prototype.addOperations = function (resource_path, ops, consumes, produces) {
    if (ops) {
      ...
      for (var i = 0; i < ops.length; i++) {
        ...
        var op = new SwaggerOperation(o.nickname, resource_path, method, o.parameters, 
        		o.summary, o.notes, type, responseMessages, this, consumes, produces, 
        		o.authorizations,o.apiLevel,o.funId,o.needAuth);
  ...
  var SwaggerOperation = function (nickname, path, method, parameters, summary, notes,
		  type, responseMessages, resource, consumes, produces, authorizations,apiLevel,funId,needAuth) {
    var _this = this;
    ...
    this.apiLevel = (apiLevel || errors.push("TyrestOperations must have a apiLevel."));
    this.funId = (funId || errors.push("TyrestOperations must have a funId."));
    this.needAuth = (needAuth || errors.push("TyrestOperations must specify whether it is needAuth or not."));
  ...
  SwaggerOperation.prototype.urlify = function (args) {
    ...
    var url = window.location.protocol + "//" + window.location.host + "/" + href[3]  + this.pathJson();//this.resource.basePath + this.pathJson();
